 ...
 *
 * <p>Lives in the {@code src/bands/atakPre53} source set, which the build adds ONLY to the
 * atak410/atak500/atak510/atak520 flavors. The 5.3+ twin lives in {@code src/bands/atak53plus}
